...
var ASM_CONSTS = {
 ...
 94107: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 94179: () => { if (document.fullscreenElement) return 1; },  
 94225: () => { return Module.canvas.width; },  
 94257: () => { return screen.width; },  
 94282: () => { document.exitFullscreen(); },  
 94309: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 94503: () => { return window.innerWidth; },  
 94529: () => { return window.innerHeight; },  
 94556: () => { if (document.fullscreenElement) return 1; },  
 94602: () => { return Module.canvas.width; },  
 94634: () => { return parseInt(Module.canvas.style.width); },  
 94682: () => { if (document.fullscreenElement) return 1; },  
 94728: () => { return Module.canvas.width; },  
 94760: () => { return screen.width; },  
 94785: () => { return window.innerWidth; },  
 94811: () => { return window.innerHeight; },  
 94838: () => { if (document.fullscreenElement) return 1; },  
 94884: () => { return Module.canvas.width; },  
 94916: () => { return screen.width; },  
 94941: () => { document.exitFullscreen(); },  
 94968: () => { if (document.fullscreenElement) return 1; },  
 95014: () => { return Module.canvas.width; },  
 95046: () => { return parseInt(Module.canvas.style.width); },  
 95094: () => { document.exitFullscreen(); },  
 95121: ($0) => { Module.canvas.style.opacity = $0; },  
 95159: () => { return screen.width; },  
 95184: () => { return screen.height; },  
 95210: () => { return window.screenX; },  
 95237: () => { return window.screenY; },  
 95264: () => { return window.devicePixelRatio; },  
 95300: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95353: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95404: () => { Module.canvas.style.cursor = 'none'; },  
 95441: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95697: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95748: () => { if (document.pointerLockElement) return 1; },  
 95795: () => { if (document.fullscreenElement) return 1; },  
 95841: () => { return window.innerWidth; },  
 95867: () => { return window.innerHeight; }
};
...
var ___start_em_js = Module['___start_em_js'] = 92348;
var ___stop_em_js = Module['___stop_em_js'] = 93954;
